...
const ARTICLES = [
  {
    ...
    body: `<h2>Transcendenceは、日本の新たなレイヴジェネレーションが創り上げたカッティングエッジなレイヴパーティだ。</h2><p><span class="ql-font-mono">都内を出発するときにはあいにくの雨だったが、現地に着く頃には気持ち良い5月の晴天に恵まれた。</span></p><p><span class="ql-font-mono">会場は、人口約600人の北相木村にある「長者の森キャンプ場」は、美しい森林に囲まれていて、忙しない都会生活に疲れた我々に安らぎを与えてくれる森林セラピーだ。</span></p><p><img src="https://lh3.googleusercontent.com/d/1s3VL1ZVlXzjS2pslw8nR4Vwt65hQvWRH=w2000"></p><p>フロアの横には小川が流れていて、川を見ながら太陽を浴びていれば、日本の山の自然の美しさの身を委ねることができる。</p><p>特にDJステージの横にある立派なカラマツの木々が印象的だった。</p><p><br></p><p>今回のレイヴで目を引いたのは演出家・四尾龍郎が率いる空間演出集団RGBによる自然と完全に調和した演出だ。</p><p>小川の流れに優しくそうような風に靡く布、カラマツの木々と調和したミニマムかつ変化が豊かなライティングに目を奪われた人も多いだろう。</p><p><img src="https://lh3.googleusercontent.com/d/17_sRgicAFNCiGI_1KyNsQMURMteyes8g=w2000"></p><p><br></p><p>音楽性に関しては、先進的でチャレンジングなテクノが中心になっていた。</p><p>特に、スイス発のGarçonとAgonisが主宰する「Amenthia Recordings」の2人が深夜帯のピークタイムを担った。</p><p>レーベル立ち上げ以来、彼らが取り組んできたドラムンリズムの概念は、脱構築テクノともいえるスタイルでフロアのクラウドを圧倒してくれた。</p><p>日本人のDJとしては、夕入りのトランジションタイムを務めたOCCA、朝方のビルドアップを得意なアシッドサウンドでまとめたオーガナイザーのDJ MARIA.が、しっかり彼らの選曲眼と個性を見せつけてくれた。</p><p><br></p><p>このパーティを支えているのが、Paramountを主宰するOtodashiチームが提供するTW Audioのサウンドシステムだ。ドイツ製のコンパクトなこのサウンドシステムは、DJのセレクトする原曲のクオリティや手元の動きが想像できるような、実に「素直」なサウンドが特徴だ。</p><p>PAブースは驚くほどミニマルで、機材を極限まで減らしてDJミキサーからスピーカーまでの間の電気信号をシンプルにまとめている。音量も大きすぎず、自分でフロアを前後すればボリュームの調整ができるため、2日間を通して音楽を楽しむことができた。</p><p><br></p><p>客層については、始まって数年のレイヴということもあり20代〜30代が中心で日本のレイヴの中では若めの客層と言えるだろう。また、外国人は1/4ほどで皆マナーがよい印象だった。1泊2日でエントランスフィーが良心的だったことや、シンプルで美しいプロモーションが要因と言えるだろう。</p><p><br></p><p>来年の開催もすでに楽しみになるほど、自然清らかなベニューで先進的なテクノを楽しめるTranscendence。こうして若い世代が野外を主催することで、次なるレイヴジェネレーションへカルチャーが引き継がれていく。主催者のDJ MARIA.とTakumi Inamoto、そして多くのスタッフの多大な努力とレイヴへの情熱に、改めて敬意を表したい。<img src="https://lh3.googleusercontent.com/d/1dv3v1mSEhofWCRItjF-6HoQYW1RlzhXd=w2000"></p>`,
    category: "REPORT",
    date: "2025-06-20",
