...
### 実施
- PCのNEWS左ビジュアルを16:9の横長比率へ変更。
- 右側の記事カードを72vhから46vhへ縮小し、記事間の縦スクロール量を削減。
...
### 次の担当への注意・判断待ち
- `http://127.0.0.1:8080/news.html`をPC幅で確認し、画像が横長、右記事カードが短くなり、スクロールしやすくなったことを確認する。モバイルで従来どおり画像付き記事一覧になることも確認する。
