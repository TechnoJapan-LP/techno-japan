...
## 2026-08-18 / Codex / 作業中（CMS集中モードのHTML表示修正）
...
### 次の担当への注意・判断待ち
- CMSでSnow Machine記事を開き、通常モードと集中モードの両方でHTML表示時にソース欄だけが表示されること、Visualへ戻ると画像ツールが復帰することを確認する。確認後にpush・Publishする。
