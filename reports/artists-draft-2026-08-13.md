# アーティスト情報の下書き — 第1弾（2026-08-13）

**CMS の ARTISTS 編集画面に貼るための下書き。**本番には未反映。

- 対象: **直近の開催に出演する、名前だけの92人**のうち、公式アカウントを
  確認できた7人（優先順は開催日）
- 出典と確度は `data/inbox/artist-<id>.json` に記録済み。
  **確度 low の値はこの下書きに載せていない**
- 紹介文（BIO / bio_en）は**確認できた事実だけ**で書いた自前の文章。
  RA の文章は著作物なので転載していない

## ⚠️ 写真について（判断待ち）

RA やレーベルサイトの写真は**撮影者に著作権があり、勝手に使えない**。
選択肢:

1. **本人の Linktree / 公式サイトのプレスキット**から取得（利用条件の明記があるもののみ）
2. **本人・所属レーベルに許諾を取る**（出演フェス経由が現実的）
3. **当面は写真なしで公開**（詳細ページは写真無しでも成立する）

推奨は 3 → 2 の順。1 は条件確認の手間が写真ごとに発生する。
**IMAGE 列はすべて空欄のままにしてある。**

---

## 1. MOODMAN（moodman）— Global Ark 8/21 出演

| 項目 | 値 | 確度 |
|---|---|---|
| INSTAGRAM | https://www.instagram.com/moodman10/ | 高 |
| SOUNDCLOUD | —（同名別人の可能性を排除できず。入れない） | — |
| CITY | TOKYO | 中 |
| GENRE | HOUSE | 編集判断 |

**BIO（案）**
> 東京のハウス・シーンを長年支えてきたDJ。GODFATHER、HOUSE OF LIQUID、
> SLOWMOTION など複数のパーティーに深く関わり、日本のクラブカルチャーを
> 現場から形づくってきた存在として知られる。

**bio_en（案）**
> A DJ who has long shaped Tokyo's house scene from the ground up,
> deeply involved in parties such as GODFATHER, HOUSE OF LIQUID and
> SLOWMOTION.

## 2. okadada（okadada）— CIRCUS ODAIBA 9/22 出演

| 項目 | 値 | 確度 |
|---|---|---|
| SOUNDCLOUD | https://soundcloud.com/okadada | 高 |
| INSTAGRAM | —（@okadada が本人か要確認） | 中 |

**BIO（案）**
> 全国各地のフロアを行き来するDJ/プロデューサー。CIRCUS Tokyo の
> audiotwo をはじめ、ジャンルを横断する自在なセットで幅広い層から
> 支持を集める。

**bio_en（案）**
> A DJ and producer active across Japan, known for genre-crossing sets
> at parties including audiotwo at CIRCUS Tokyo.

## 3. Powder（powder）— FFKT 9/26 出演

| 項目 | 値 | 確度 |
|---|---|---|
| WEBSITE | https://powd.jp/ | 高 |
| BANDCAMP | —（本人名義なし。リリースはレーベル側） | — |
| GENRE | HOUSE | 中（left-field house） |

**BIO（案）**
> 長崎出身、2011年より東京を拠点とするDJ/プロデューサー Moko Shibata の
> ソロ名義。2017年に CockTail d'Amore から EP『H』を発表して以降、
> Beats in Space、ESP Institute、The Trilogy Tapes などから作品を重ね、
> レフトフィールド・ハウスの旗手として国際的に活動する。

**bio_en（案）**
> The solo alias of Moko Shibata, a Nagasaki-born, Tokyo-based DJ and
> producer. Since her 2017 EP "H" on CockTail d'Amore she has released
> on Beats in Space, ESP Institute and The Trilogy Tapes, earning
> international recognition as a leading figure in left-field house.

## 4. Acid Pauli（acid-pauli）— FESTIVAL de FRUE 出演

| 項目 | 値 | 確度 |
|---|---|---|
| SOUNDCLOUD | https://soundcloud.com/acidpauli | 高 |
| INSTAGRAM | https://www.instagram.com/therealacidpauli | **中 — 貼る前に本人か確認** |
| COUNTRY | GERMANY | 高 |
| CITY | BERLIN | 中 |

**BIO（案）**
> ベルリンを拠点とする Martin Gretschmann のソロ名義。Nico Stojan と共に
> レーベル Ouïe を主宰し、ダンスフロアと実験性を行き来する自由なセットで
> 知られる。

**bio_en（案）**
> The solo project of Berlin-based Martin Gretschmann, who co-runs the
> label Ouïe with Nico Stojan and is known for free-roaming sets that
> move between the dancefloor and experimentation.

## 5. AKIRAM EN（akiram-en）— FFKT 9/26 出演

| 項目 | 値 | 確度 |
|---|---|---|
| INSTAGRAM | https://www.instagram.com/akiram_en/ | 高 |
| SOUNDCLOUD | https://soundcloud.com/akiram-en | 高 |
| CITY | TOKYO | 高 |
| GENRE | TECHNO | 編集判断 |

**BIO（案）**
> 90年代半ばにキャリアを開始し、日本のアンダーグラウンド・シーンに
> 長く根を張るDJ。DJ KRUSH との共演をはじめ、東京を中心に現場での
> 信頼を積み重ねてきた。

**bio_en（案）**
> A DJ whose career began in the mid-90s and who has been a permanent
> fixture of Japan's underground scene, sharing bills with artists
> including DJ KRUSH.

## 6. Sylvan Esso（sylvan-esso）— FESTIVAL de FRUE 出演

| 項目 | 値 | 確度 |
|---|---|---|
| BANDCAMP | https://sylvanesso.bandcamp.com/ | 高 |
| WEBSITE | https://sylvanesso.com | 中 — 貼る前に開いて確認 |
| COUNTRY | USA | 高 |
| GENRE | LIVE | 編集判断 |

**BIO（案）**
> Amelia Meath と Nick Sanborn によるエレクトロニック・ポップ・デュオ。
> ノースカロライナ州ダーラムを拠点に4作のアルバムを発表し、グラミー賞に
> 2度ノミネートされている。

**bio_en（案）**
> An electronic pop duo of Amelia Meath and Nick Sanborn based in
> Durham, North Carolina, with four albums and two Grammy nominations.

## 7. Alabaster DePlume（alabaster-deplume）— FESTIVAL de FRUE 出演

| 項目 | 値 | 確度 |
|---|---|---|
| INSTAGRAM | https://www.instagram.com/alabaster_deplume/ | 高 |
| BANDCAMP | —（本人名義なし。リリースは intlanthem.bandcamp.com） | — |
| COUNTRY | UK | 中 |
| GENRE | EXPERIMENTAL | 編集判断 |

**BIO（案）**
> サックス奏者・詩人。シカゴのレーベル International Anthem から
> 『GOLD』（2022）『Come With Fierce Grace』（2023）などを発表し、
> ジャズと語りの境界を漂う独自の表現で知られる。

**bio_en（案）**
> A saxophonist and poet releasing on Chicago's International Anthem,
> including "GOLD" (2022) and "Come With Fierce Grace" (2023), known
> for drifting between jazz and spoken word.

---

## 未調査（次のバッチ）

直近開催の出演者で情報が名前だけの残り **14人**:

- **Global Ark（8/21・最優先）**: choko / sunga / tsutomu
  — 一般名詞に近く Web 検索での特定が難しい。**フェス公式の出演者告知
  （Instagram）から本人アカウントを辿るのが確実**
- synapse-festival: ground / noritake / ysk / joma
- odyssey: suimin ／ otsukimi: so ／ colors: occa
- festival-de-frue: kiko-dinucci / the-master-musicians-of-joujouka /
  kuo-from-sunset-rollercoaster

さらにその後ろに、開催が先のフェスの出演者 **71人**。

## 入力の手順（CMS）

1. CMS → ARTISTS → 該当アーティストを開く
2. 表の値と BIO / bio_en を貼る（**確度「中」の URL は開いて本人確認してから**）
3. STATUS を published に
4. 全員ぶん終わったら Publish Now（1回でよい）
